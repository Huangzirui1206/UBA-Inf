...
if __name__ == '__main__':
    # To download Tiny-Imagenet dataset by hand and init val data_folder
    # run under root folder path
    import argparse
    import sys
    parser = argparse.ArgumentParser(description=sys.argv[0])
    parser.add_argument('--save_path', type=str, default='./data/tiny/tiny-imagenet-200/val')
    parser.add_argument('--img_folder', type=str, default='images')
    parser.add_argument('--annotations_file', type=str, default='val_annotations.txt')
    args = parser.parse_args()
    normalize_tin_val_folder_structure(args.save_path, args.img_folder, args.annotations_file)