...
class d_st(defense):
    ...
    def add_arguments(parser):
        ...
        parser.add_argument('--wd', type=float, help='weight decay of sgd', default=5e-4)
    ...
    def set_result(self, result_file):
        ...
        self.result = load_attack_result(attack_file + '/' + args.result_name)
    ...
    def mitigation(self):
        ...
        save_defense_result(
            ...
            model=model_new.cpu().state_dict() if model_new else None,
