...
def generate_cls_model(
    ...
    if model_name == 'resnet18':
        ...
        net = AlexNet(num_classes=num_classes, **kwargs)
        ...
        # net_from_imagenet = models.mobilenet_v3_large(pretrained=pretrained, )  # num_classes = num_classes)
        # net = models.mobilenet_v3_large(num_classes=num_classes, **{k: v for k, v in kwargs.items() if k != "pretrained"})
    elif model_name == 'mobilenet_v3_small':
        net = models.mobilenet_v3_small(num_classes=num_classes, **kwargs)
        # net_from_imagenet = models.mobilenet_v3_small(pretrained=pretrained, )  # num_classes = num_classes)
        # net = models.mobilenet_v3_small(num_classes=num_classes, **{k: v for k, v in kwargs.items() if k != "pretrained"})
        ...
        # net = EfficientNetB0(num_classes=num_classes, **kwargs)
        ...
        net_from_imagenet = convnext_tiny(pretrained=pretrained, )  # num_classes = num_classes)
