...
class BadNet(NormalCase):
    ...
    def __init__(self, clean_label=False, cv_img_trans='test'):
        self.clean_label=clean_label
        self.cv_img_trans=cv_img_trans # 'train' or 'test'
        assert cv_img_trans in ['train', 'test']
    ...
    def stage1_non_training_data_prepare(self):
        ...
        if args.add_cover != 0:    
            ...
            cv_label_transform = None # add_cover is 0, so cv_label_transform is unnecessary
        ...
        bd_train_dataset = prepro_cls_DatasetBD_v2(
            ...
            cv_image_pre_transform=test_bd_img_transform if self.cv_img_trans == 'test' else train_bd_img_transform,
